...
def download_github_code(path):
    ...
    os.system('wget -q https://github.com/hse-cs-ami/coursera-intro-dl/blob/main/{} -O {}'.format(path, filename))  # TODO: make actual link


def download_github_release(path):
    filename = path.rsplit('/')[-1]
    os.system('shred -u {}'.format(filename))
    os.system('wget -q https://github.com/hse-cs-ami/coursera-intro-dl/releases/download/{} -O {}'.format(path, filename))  # TODO: make actual link
